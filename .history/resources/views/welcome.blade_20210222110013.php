                ...
                <form action="{{ route('home') }}" method="GET">
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" value="{{ request()->get('name') == null ? 'Pilih Category' : request()->get('name') }}" class="form-control" name="name" placeholder="Cari berdasarkan nama">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <button class="btn btn-success w-100"><i class="fas fa-paper-plane"></i></button>
                    </div>
                </form>
            </div>
        </div>
