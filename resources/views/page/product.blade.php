...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            @if (Auth::check())
                @if (Auth::user()->level == null || Auth::user()->level == 'client')
                <div class="row">
                    <div class="col-9">
                ...
                @else
                <div class="alert alert-danger fade show py-2 px-4" role="alert">
                    <strong>Kesahalan! : </strong> Anda bukan user
                </div>
                @endif
            @else
            <div class="alert alert-danger fade show py-2 px-4" role="alert">
                <strong>Kesalahan! : </strong> Anda belum login
            </div>
            @endif
        </div>
    </div>
